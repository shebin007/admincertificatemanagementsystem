...
<hr>
 ...
 $certhash =md5($fname.$lname.$organ.$issue.$rank.$date);
 ...
 <div class="jumbotron"  id="printableArea">
  ...
  <h3 style="text-align: center;">of</h3>
    <?php
      ...
      echo "<br><br><br><h5>ID :<a href='http://localhost/adminaward/validated.php?hash=". $certhash."&assign='>".$certhash."</h5>";
   ?>
   </div>
</div>
<a href="javascript:void(0);" class="btn btn-primary" onclick="printPageArea('printableArea')">Download Certificate</a>
<?php
  echo "<a href='http://www.linkedin.com/shareArticle?mini=true&amp;url=http://localhost/awardsystem/validated.php?hash=". $certhash."&assign=' class='btn btn-secondary' target='_blank'>Share Certificate</a>";
